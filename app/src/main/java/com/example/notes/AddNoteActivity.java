...
public class AddNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerDaysOfWeek = findViewById(R.id.spinnerDaysOfTheWeek);
    ...
    public void onClickAddNote(View view) {
        ...
        int dayOfTheWeek = spinnerDaysOfWeek.getSelectedItemPosition();
        ...
        if (isFilled(title, description)) {
            ...
            contentValues.put(NotesContract.NotesEntry.COLUMN_DAY_OF_THE_WEEK, dayOfTheWeek + 1);
